...
# <codecell> Rerun hyperparameter tuning
...
# The best_params_ from a pca of n_components=0.60 were min_samples_split=10
# and n_estimators=300

# Set hyperparameters for our RFC classifiers
n_est = 300  # Number of estimators
min_ss = 10  # Minimum samples split
...
# Make predictions on train and test sets
train_pred_pca = rfc.predict(X_train_pca)
test_pred_pca = rfc.predict(X_test_pca)
